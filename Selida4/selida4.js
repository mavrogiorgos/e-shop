...
function addToCart()
{
  ...
  if(document.getElementById("check1").checked == true)
  {
    ...
    document.getElementById("product1").innerHTML = ("<?php echo $array[0]['name'];?>\t"+quantity1);
    price1 = quantity1 * "<?php echo $array[0]['price'];?>";
  ...
  if(document.getElementById("check2").checked == true)
  {
    ...
    document.getElementById("product2").innerHTML = ("<?php echo $array[1]['name'];?>\t"+quantity2);
    price2 = quantity2 * "<?php echo $array[1]['price'];?>";
  }
  ...
  if(document.getElementById("check3").checked == true)
  {
    ...
    quantity3 = parseInt(document.getElementById("quantity3").value);
      document.getElementById("product3").innerHTML = ("<?php echo $array[2]['name'];?>\t"+quantity3);
    price3 = quantity3 * "<?php echo $array[2]['price'];?>";
  }
  ...
  if(document.getElementById("check4").checked == true)
  {
    ...
    document.getElementById("product4").innerHTML = ("<?php echo $array[3]['name'];?>\t"+quantity4);
    price4 = quantity4 * "<?php echo $array[3]['price'];?>";
  }
  ...
  if(document.getElementById("check5").checked == true)
  {
    ...
    document.getElementById("product5").innerHTML = ("<?php echo $array[4]['name'];?>\t"+quantity5);
    price5 = quantity5 * "<?php echo $array[4]['price'];?>";
  }
  ...
  if(document.getElementById("check6").checked == true)
  {
    ...
    document.getElementById("product6").innerHTML = ("<?php echo $array[5]['name'];?>\t"+quantity6)
    price6 = quantity6 * "<?php echo $array[5]['price'];?>";
  }
